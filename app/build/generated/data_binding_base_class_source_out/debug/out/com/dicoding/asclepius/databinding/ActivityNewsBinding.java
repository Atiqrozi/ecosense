...
public final class ActivityNewsBinding implements ViewBinding {
  ...
  private ActivityNewsBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull RecyclerView news) {
  ...
  public static ActivityNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewsBinding((ConstraintLayout) rootView, main, news);
    }

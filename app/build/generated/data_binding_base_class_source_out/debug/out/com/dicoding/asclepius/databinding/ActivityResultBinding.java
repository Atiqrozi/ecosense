...
public final class ActivityResultBinding implements ViewBinding {
  ...
  private ActivityResultBinding(@NonNull ScrollView rootView, @NonNull ImageView resultImage,
      @NonNull TextView resultText, @NonNull Button tryAgainButton) {
  ...
  public static ActivityResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultBinding((ScrollView) rootView, resultImage, resultText,
          tryAgainButton);
    }

...
public final class ModelWithMetadata {
  ...
  private ModelWithMetadata(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    ...
    ImageProcessor.Builder imageProcessorBuilder = new ImageProcessor.Builder()
      .add(new ResizeOp(150, 150, ResizeMethod.NEAREST_NEIGHBOR))
  ...
  @NonNull
  public static ModelWithMetadata newInstance(@NonNull Context context) throws IOException {
    return new ModelWithMetadata(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelWithMetadata newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new ModelWithMetadata(context, options);
  }
